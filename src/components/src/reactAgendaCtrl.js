...
export default class ReactAgendaCtrl extends Component {
  constructor() {
    ...
    this.state = {
      ...
      classes: 'priority-1',
      startDateTime: now,
      endDateTime: moment().add(15, 'minutes')
    }
  ...
  if (!this.props.selectedCells.length) {
    let start = this.props.selectedCells
    let endT = moment(start).add(15, 'Minutes');
        ...
        <form onSubmit={this.handleEdit}>
          ...
          <div className="agendCtrls-timePicker-wrapper">
            <div className="agendCtrls-time-picker">
              ...
              <DateTimePicker value={this.state.startDateTime} onChange={this.handleDateChange.bind(null, 'startDateTime')}/>
            </div>
            <div className="agendCtrls-time-picker">
              <label >Data de término</label>
              <DateTimePicker   onChange={this.handleDateChange.bind(null, 'endDateTime')}/>
            </div>
          </div>
    ...
    <div className="agendCtrls-wrapper" style={divStyle}>
      <form onSubmit={this.handleSubmit}>
        ...
        <div className="agendCtrls-timePicker-wrapper">
          ...
          <div className="agendCtrls-time-picker">
            <label >Data de término</label>
            <DateTimePicker  value={this.state.endDateTime} onChange={this.handleDateChange.bind(null, 'endDateTime')}/>
          </div>
        </div>
